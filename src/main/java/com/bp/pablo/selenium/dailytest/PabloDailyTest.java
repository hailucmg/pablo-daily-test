...
//			/********* end checking server is still alive **********/
			...
			if(continueCheck){
					...
					if(attr.equalsIgnoreCase("logout")){
						 ...
						 try {
							...
							if(!payrollTitle.equals("Next payroll cut-off")){
								SendMailSSL.sendMailCMG("<h2>The Title of payroll in homepage is not equal with 'Next payroll cut-off'</h2><br>Please help me to check this!<br>", "Pablo server have problem");
							}else{
								 //bodyText ="<h3>Test function homepage passed </h3><br>";
								 WriteLogFile.logger.info("Test function homepage passed");
							}
						} catch (Exception e) {
							bodyText +="<h2>The Title of payroll in homepage is not existed</h2><br>Please help me to check this!";
				...
				if(selenium.isTextPresent("Diary centre")){
					...
					try {
						...
						if(options!=null){
							...
							bodyText += "<h3 style=\"color:red\">Cannot loading data in dropdowlist in  " + ps.getMainview_diary_url() +" </h3><br>";
					...
					if(notifi.contains("There was a communication error:")){
						bodyText += "<h3 style=\"color:red\">Cannot loading case work of "+ acc.getUsername_admin()+" in " + ps.getMainview_diary_url() +" at the time : "+ System.currentTimeMillis() +"</h3><br>";
						WriteLogFile.logger.info("Cannot loading case work in " + ps.getMainview_diary_url());
						//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
					}
							    ...
							    if(option.getText().equalsIgnoreCase(ListvalueOfdropdowList.get(i))){
							        ...
							        try {
										...
										if(note.contains("There was a communication error:")){
											bodyText += "<h3 style=\"color:red\">Cannot loading case work of "+option.getText() +" in " + ps.getMainview_diary_url() +" at the time : "+ System.currentTimeMillis() +"</h3><br>";
											WriteLogFile.logger.info("Cannot loading case work in " + ps.getMainview_diary_url());
											//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
										}
										continue;
										...
										if(TableRowCount > 0 ){
											...
											if(popupPriority.isDisplayed()){
												...
												if(optionsOfUserMapping == null){
													bodyText += "<h3 style=\"color:red\">The dropdown list is empty when click to the button Reallocate To in " + ps.getMainview_diary_url() +" </h3><br>";
												...
												bodyText += "<h3 style=\"color:red\">The popup is not display when click to the button priority  in " + ps.getMainview_diary_url() +" </h3><br>";
					...
					bodyText += "<h3 style=\"color:red\">Cannot open website "+ps.getMainview_diary_url()+"</h3><br>";
					WriteLogFile.logger.info("Server was broken. Can not open website");
					//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
				}
				...
				if(selenium.isTextPresent("Colours")){
					...
					bodyText += "<h3 style=\"color:red\">Cannot open website "+ps.getDiary_color_config()+"</h3><br>";
				...
				try {
					...
					if(tableTop.isDisplayed()){
						...
						if(TableRowCount == 3){
							try {
								...
								if(buttonEditOfMouseOver.isDisplayed()){
									bodyText += "<h3 style=\"color:red\">THe button edit is display in the mouseover in :"+ps.getDiary_color_config()+"</h3><br>";
							...
							try {
								...
								if(buttonEditOfDisclosuer.isDisplayed()){
									...
									bodyText += "<h3 style=\"color:red\">THe button edit is not display in the disclosure in :"+ps.getDiary_color_config()+"</h3><br>";
							...
							try {
								...
								if(buttonEditOfpayroll.isDisplayed()){
									...
									bodyText += "<h3 style=\"color:red\">THe button edit is not display in the payroll in :"+ps.getDiary_color_config()+"</h3><br>";
						...
						bodyText += "<h3 style=\"color:red\">Can't load  table location top is not display in :"+ps.getDiary_color_config()+"</h3><br>";
						WriteLogFile.logger.info("Can't load  table  location top is not display in :"+ps.getDiary_color_config());
						//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
					}
				} catch (Exception e) {
					bodyText += "<h3 style=\"color:red\">Can't load  table location top in :"+ps.getDiary_color_config()+"</h3><br>";
					...
					if(tableBottom.isDisplayed()){
						try {
							...
							if(buttAdd.isDisplayed()){
								...
								bodyText += "<h3 style=\"color:red\">THe button add is not display in the table bottom in :"+ps.getDiary_color_config()+"</h3><br>";
						...
						bodyText += "<h3 style=\"color:red\">Can't load  table location bottom in :"+ps.getDiary_color_config()+"</h3><br>";
				...
				if(selenium.isTextPresent("Diary summary")){
					...
					bodyText += "<h3 style=\"color:red\">Cannot open website "+ps.getDiary_summary()+"</h3><br>";
				...
				try {
					...
					if(lastUpdated.trim().length() == 0 || lastUpdated == null){
						bodyText += "<h3 style=\"color:red\">The display of last updated null in "+ps.getDiary_summary()+ " </h3><br>";
					...
					if(totalCase.equalsIgnoreCase("Total Cases")){
						...
						bodyText += "<h3 style=\"color:red\">The display of last updated"+ps.getDiary_summary()+ " is not right</h3><br>";
					...
					if(slaStatus.trim().equalsIgnoreCase("SLA status")){
						...
						bodyText += "<h3 style=\"color:red\">The display of SLA status "+ps.getDiary_summary()+ " is not right</h3><br>";
					...
					if(workFlow.equalsIgnoreCase("Workflow status")){
						...
						bodyText += "<h3 style=\"color:red\">The display of Workflow status "+ps.getDiary_summary()+ " is not right</h3><br>";
					...
					if(deparment.equalsIgnoreCase("Department")){
						...
						bodyText += "<h3 style=\"color:red\">The display of Department in " +ps.getDiary_summary()+ " is not right</h3><br>";
						WriteLogFile.logger.info("The display of Department in :" +ps.getDiary_summary() +" is not right");
						//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");	
					}
				} catch (Exception e) {
					bodyText += "<h3 style=\"color:red\">The display of "+ps.getDiary_summary()+ " is not right</h3><br>";
				...
				/***** start checking Team management ********/
					...
					//bodyText = "<h3>Go to Team management passeed</h3><br>";
						...
						bodyText += "<h3 style=\"color:red\">Cannot open website "+ps.getTeam_allocation_url()+"</h3><br>";
						...
						if(tableAllocation.isDisplayed()){
							...
							if(TableRowCount > 1){
								...
								if(listUser.size() > 0){
									...
									if(checkDupplicate){
										bodyText += "<h3 style=\"color:red\">Dupplicated user "+  userDupplicate + " in :</h3>"  +ps.getTeam_allocation_url()+"<br>";
							...
							bodyText += "<h3 style=\"color:red\">The display of tableAllocation "+ps.getTeam_allocation_url()+ " is not right</h3><br>";
							WriteLogFile.logger.info("The display of tableAllocation: " +ps.getTeam_allocation_url() +" is not right");
							//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
						}
					} catch (Exception e) {
						bodyText += "<h3 style=\"color:red\">The display of tableAllocation is missing in :</h3> "+ps.getTeam_allocation_url()+ "<br>";
				...
				if(selenium.isTextPresent("Payroll dates")){
					...
					bodyText += "<h3 style=\"color:red\">Cannot open website "+ps.getPayroll_url()+"</h3><br>";
					...
					if(tablePayroll.isDisplayed()){
						try {
							...
							if(buttonAdd.isDisplayed()){
									...
									if(popupAdd.isDisplayed()){
										...
										List<WebElement> options = dropdowDateMonth.findElements(By.tagName("option"));
										 ...
										 if(checkYear){
												...
												bodyText += "<h3 style=\"color:red\">The display of dropdown when click add button is wrong<h3><br>";
												WriteLogFile.logger.info("The display of  dropdown when  add button is wrong");
												//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");	
										 }
									}else{
										bodyText += "<h3 style=\"color:red\">The display of popup when click add button is missing<h3><br>";
								...
								bodyText += "<h3 style=\"color:red\">The display of add button is missing<h3><br>";
									...
									if(buttonEdit.isDisplayed()){
										...
										try {
											...
											if(popupEdit.isDisplayed()){
												...
												bodyText += "<h3 style=\"color:red\">The display of popup when click edit button is missing<h3><br>";
										...
										bodyText += "<h3 style=\"color:red\">The display of  edit button in payroll is missing<h3><br>";
								...
								if(buttonEdit.isDisplayed()){
									...
									try {
										...
										if(popupEdit.isDisplayed()){
											...
											bodyText += "<h3 style=\"color:red\">The display of popup when click edit button in payroll is missing<h3><br>";
									...
									bodyText += "<h3 style=\"color:red\">The display of edit button  is missing<h3><br>";
						...
						bodyText += "<h3 style=\"color:red\">The display of tablePayroll is missing<h3><br>";
				...
				if(selenium.isTextPresent("Bank holidays")){
					...
					bodyText += "<h3 style=\"color:red\">Cannot open website "+ps.getBank_holiday_url()+"</h3><br>";
					...
					if(tableBank.isDisplayed()){
						try {
							...
							if(buttonAdd.isDisplayed()){
									...
									if(popupAdd.isDisplayed()){
										try {
											...
											if(submitButton.isDisplayed()){
												...
												bodyText += "<h3 style=\"color:red\">The display of submit button in popup when click Add button in bank holiday  is missing<h3><br>";
										...
										bodyText += "<h3 style=\"color:red\">The display of popup when click add button in bank holiday is missing<h3><br>";
								...
								bodyText += "<h3 style=\"color:red\">The display of add button in bank holiday  is missing<h3><br>";
						...
						if(TableRowCount > 1){
							try {
								...
								if(buttonEdit.isDisplayed()){
										...
										if(popupEdit.isDisplayed()){
											try {
												...
												if(buttonUpdate.isDisplayed()){
													...
													bodyText += "<h3 style=\"color:red\">The display of update button in popop when click EDIT button in bank holiday  is missing<h3><br>";
											...
											bodyText += "<h3 style=\"color:red\">The display of popup when click eidt button in bank holiday is missing<h3><br>";
									...
									bodyText += "<h3 style=\"color:red\">The display of edit button in bank holiday  is missing<h3><br>";
						...
						bodyText += "<h3 style=\"color:red\">The display of table bank holiday is missing<h3><br>";
				...
				if(selenium.isTextPresent("Drop box administration")){
					...
					bodyText += "<h3 style=\"color:red\">Cannot open website :"+ ps.getDropbox_administrator() + "<h3><br>";
				...
				try {
					...
					if(tableAdmin.isDisplayed()){
							...
							if(buttonAddDropbox.isDisplayed()){
								...
								try {
									...
									if(popupAddDropbox.isDisplayed()){
										...
										if(TableRowCount >= 5){
											try {
												...
												if(options.isEmpty() || options.size() == 0){
													bodyText += "<h3 style=\"color:red\">The select duration in add dropbox popup is null <h3><br>";
											...
											try {
												...
												if(options.isEmpty() || options.size() == 0){
													bodyText += "<h3 style=\"color:red\">The select owner in add dropbox popup is null <h3><br>";
											...
											bodyText += "<h3 style=\"color:red\">The display of table in popup add dropbox when click Add button in dropbox administrator is wrong<h3><br>";
										...
										bodyText += "<h3 style=\"color:red\">The display of popup add dropbox when click Add button in dropbox administrator is missing<h3><br>";
								...
								bodyText += "<h3 style=\"color:red\">The button add dropbox in dropbox administrator is missing<h3><br>";
						...
						if(TableRowCount > 1){
							try {
								dropboxRandom = selenium.getText("xpath=//table[@id='dropbox' and @class='tablesorter']/tbody/tr[2]/td[2]");
								WebElement buttonAddUser = driver.findElement(By.xpath("//table[@id='dropbox' and @class='tablesorter']/tbody/tr[2]/td[5][@class='blank']/input[@class='dropboxInfo']"));
								if(buttonAddUser.isDisplayed()){
											...
											try {
												...
												if(btnAddUser.isDisplayed()){
													...
													if(viewDropUser.isDisplayed()){
														...
														bodyText += "<h3 style=\"color:red\">The popup when click btnAddUser in dropbox administrator is missing<h3><br>";
														WriteLogFile.logger.info("The popup when click btnAddUser in dropbox administrator is missing");
														//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
													}
												}else{
													bodyText += "<h3 style=\"color:red\">The button btnAddUser  in dropbox administrator is missing<h3><br>";
													WriteLogFile.logger.info("The button btnAddUser in dropbox administrator is missing");
													//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
												}
											} catch (Exception e) {
												bodyText += "<h3 style=\"color:red\">There are some error in function add user to dropbox<h3><br>";
												WriteLogFile.logger.info("There are some error in function add user to dropbox");
												//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
											}
										}else{
											bodyText += "<h3 style=\"color:red\">The display of popup add user when click Add user to dropbox in dropbox administrator is missing<h3><br>";
									...
									bodyText += "<h3 style=\"color:red\">The button add user to dropbox in dropbox administrator is missing<h3><br>";
						...
						bodyText += "<h3 style=\"color:red\">The table in dropbox administrator is missing<h3><br>";
				...
				if(selenium.isTextPresent("Dropboxes")){
					...
					bodyText += "<h3 style=\"color:red\">Cannot open website :"+ ps.getDropbox_url() + "<h3><br>";
				...
				if(dropboxRandom == null || dropboxRandom.trim().length() == 0){
					...
					if(notifi.equalsIgnoreCase("No dropbox found.")){
						...
						bodyText += "<h3 style=\"color:red\">There are some error(when no dropbox found) in " +ps.getDropbox_url()+"<br>";
						...
						if(listOfDroboxes.isDisplayed()){
							...
							if(options.size() > 0){
								...
								if(!checkExistDropbox){
									bodyText += "<h3 style=\"color:red\">Data in the dropdowlist of dropbox is not equal with dropbox administrator in " +ps.getDropbox_url()+"<br>";
								...
								bodyText += "<h3 style=\"color:red\">Can not find any data in the dropdowlist of dropbox in " +ps.getDropbox_url()+"<br>";
								WriteLogFile.logger.info("Can not find any data in the dropdowlist of dropbox in :"+ ps.getDropbox_url() + "<h3>");
								//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
							}
						}else{
							bodyText += "<h3 style=\"color:red\">Can not find the dropdowlist of dropbox in " +ps.getDropbox_url()+"<br>";
						...
						if(DisplayUpload.isDisplayed()){
							try {
								...
								if(type.equalsIgnoreCase("file")){
									...
									bodyText += "<h3 style=\"color:red\">In side The upload file have some error like the button of upload is not type = file : " +ps.getDropbox_url()+"<br>";
								...
								bodyText += "<h3 style=\"color:red\">In side The upload file have some error : " +ps.getDropbox_url()+"<br>";
								WriteLogFile.logger.info("Inside The upload file have some error  :"+ ps.getDropbox_url() + "<h3>");
								//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
							}
						}else{
							bodyText += "<h3 style=\"color:red\">Can not find the location of upload file  : " +ps.getDropbox_url()+"<br>";
							WriteLogFile.logger.info("Can not find the location of upload file  :"+ ps.getDropbox_url() + "<h3>");
							//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");	
						}
					} catch (Exception e) {
						bodyText += "<h3 style=\"color:red\">The upload file have some error : " +ps.getDropbox_url()+"<br>";
					...
					try {
						...
						if(tableDownload.isDisplayed()){
								...
								if(filetext.equalsIgnoreCase("No file found.")){
									...
									try {
										...
										if(inforButton.isDisplayed()){
											...
											try {
												...
												if(popupInfor.isDisplayed()){
													...
													if(rowInsde == 3){
														...
														bodyText += "<h3 style=\"color:red\">The table of infor popup have " + rowInsde +" <tr> : " +ps.getDropbox_url()+"<br>";
														WriteLogFile.logger.info("The table of infor popup have " + rowInsde +" <tr> : " +ps.getDropbox_url());
														//SendMailSSL.sendMailCMG(bodyText, "Pablo server have a problem");
													}
												}else{
													bodyText += "<h3 style=\"color:red\">Can not find the popup infor when click to the button infor in table download : " +ps.getDropbox_url()+"<br>";
											...
											bodyText += "<h3 style=\"color:red\">Can not find the button infor in table download : " +ps.getDropbox_url()+"<br>";
							...
							bodyText += "<h3 style=\"color:red\">Can not find the table of download : " +ps.getDropbox_url()+"<br>";
				...
				if(selenium.isTextPresent("Dropbox configuration")){
					...
					bodyText += "<h3 style=\"color:red\">Cannot open website :"+ ps.getDropbox_configuration() + "<h3><br>";
				...
				try {
					...
					if(table.isDisplayed()){
						...
						bodyText += "<h3 style=\"color:red\">Can not find the table configuration : " +ps.getDropbox_configuration()+"<br>";
				...
				/******* end checking dropbox configuration *******/
					...
					if(bodyText.trim().length() >0){
						...
						SendMailSSL.sendMailCMG("<h3>All function is running good now!<br>Thank You", "Pablo Server Daily Test");
					}
